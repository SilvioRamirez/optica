        ...
        <div class="card border-light mb-3 shadow">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="filtro-container">
                                ...
                                <select id="filtro-tipo-pago" class="form-select form-select-sm" style="width: auto; display: inline-block;">
                            ...
                            <table class="table table-bordered table-hover" id="tabla-pagos">
                                ...
                                <tfoot>
                                    ...
                                    <tr id="total-general" class="table-primary">
                                        ...
                                        <td colspan="5" class="fw-bold">0.00</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h4>Formularios creados o actualizados</h4>
                            <div class="filtro-container">
                                <label for="filtro-estatus" class="form-label me-2">Filtrar por estado:</label>
                                <select id="filtro-estatus" class="form-select form-select-sm" style="width: auto; display: inline-block;">
                            ...
                            <table class="table table-bordered table-hover" id="tabla-formularios">
                                ...
                                <tfoot>
                                    ...
                                    <tr id="total-formularios" class="table-primary">
                                        <td colspan="3" class="text-end fw-bold">Total de Formularios:</td>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        tiposPago.forEach(tipo => {
                            $('#filtro-tipo-pago').append(`<option value="${tipo.id}">${tipo.nombre}</option>`);
                        });
                        ...
                        estatusFormularios.forEach(estatus => {
                            $('#filtro-estatus').append(`<option value="${estatus}">${estatus}</option>`);
                        });
                ...
                Object.values(pagosPorTipo).forEach(grupo => {
                    ...
                    $('#tabla-pagos tbody').append(`
                        <tr class="table-secondary">
                            <td colspan="7" class="fw-bold">Tipo de pago: ${grupo.nombre}</td>
                        </tr>
                    `);
                    ...
                    grupo.pagos.forEach(pago => {
                        ...
                        $('#tabla-pagos tbody').append(`
                            <tr>
                                ...
                                <td>${pago.formulario ? pago.formulario.id : '-'}</td>
                                <td>${hora}</td>
                                <td>
                                    <a href="/pagos/${pago.id}" class="btn btn-info btn-sm">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
                    ...
                    $('#tabla-pagos tbody').append(`
                        <tr class="table-info">
                            <td colspan="2" class="text-end fw-bold">Subtotal ${grupo.nombre}:</td>
                            <td colspan="5" class="fw-bold">${grupo.total.toFixed(2)}</td>
                        </tr>
                    `);
                });
            ...
            function mostrarFormularios(formularios, filtroEstatus = 'todos') {
                ...
                Object.values(formulariosPorEstado).forEach(grupo => {
                    ...
                    $('#tabla-formularios tbody').append(`
                        <tr class="table-secondary">
                            <td colspan="7" class="fw-bold">Estado: ${grupo.nombre}</td>
                        </tr>
                    `);
                    ...
                    grupo.formularios.forEach(formulario => {
                        ...
                        $('#tabla-formularios tbody').append(`
                            <tr>
                                ...
                                <td>${hora}</td>
                                <td>
                                    <a href="/formularios/${formulario.id}" class="btn btn-info btn-sm">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
                    ...
                    $('#tabla-formularios tbody').append(`
                        <tr class="table-info">
                            <td colspan="3" class="text-end fw-bold">Cantidad de formularios en ${grupo.nombre}:</td>
