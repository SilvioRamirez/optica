...
@section('content_header')
    <h1 class="text-center"><i class="fa fa-trash-alt"></i> Eliminar Cliente</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-trash-alt"></i> Eliminar Cliente
            </div>
            <div class="float-end">
        ...
        <div class="card-body">			
            ...
            {!! Form::open(['method' => 'DELETE','route' => ['clientes.destroy', $cliente->id],'style'=>'display:inline']) !!}
                ...
                <h2 class="text-center">¿Está segur@ de eliminar el Cliente: <strong>{{ $cliente->name }}</strong>?</h2>
                <hr>
