...
@section('title', 'Condiciones Opticas')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-eye"></i> Condiciones Opticas</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-eye"></i> Condiciones Opticas
            </div>
            <div class="float-end">
        ...
        function openModalDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var urlDelete = 'api/condicionOptica/' + `${id}`;
