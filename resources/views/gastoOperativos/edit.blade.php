...
@section('title', 'Editar Gasto de Operativo')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-edit"></i> Editar Gasto de Operativo</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-edit"></i> Editar Gasto de Operativo
            </div>
            <div class="float-end">
