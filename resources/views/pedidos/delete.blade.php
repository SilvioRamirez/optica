...
@section('content_header')
    <h1 class="text-center"><i class="fa fa-id-badge"></i> Eliminar Categoria</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-id-badge"></i> Eliminar Categoria
            </div>
            <div class="float-end">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['method' => 'DELETE','route' => ['categorias.destroy', $categoria->id],'style'=>'display:inline']) !!}
                ...
                <h2 class="text-center">¿Está segur@ de eliminar la Categoria: <strong>{{ $categoria->nombre }}</strong>?</h2>
                <hr>
