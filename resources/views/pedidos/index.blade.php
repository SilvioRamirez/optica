...
@section('content_header')
    <h1 class="text-center"><i class="fa fa-boxes-packing"></i> Administración de Pedidos</h1>
@stop
            ...
            <div class="card-header bg-primary text-white">
                @can('refracante-create')
                    <div class="float-start">
                        <a href="{{ route('pedidos.create') }}" class="btn btn-light btn-sm"><i class="fa fa-plus"></i>
                            {{ __('Create New') }}</a>
                    </div>
                @endcan
                <div class="float-end">
