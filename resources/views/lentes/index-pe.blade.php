...
@section('title', 'Administración de Lentes Por Entregar')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-person-circle-check"></i> Administración de Lentes Por Entregar</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-person-circle-check"></i> Administración de Lentes Por Entregar
            </div>
            <div class="float-end">
...
<div class="modal fade" id="peLenteModal" tabindex="-1" aria-labelledby="peLenteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h1 class="modal-title fs-5" id="peLenteModalLabel"><i class="fa fa-check"></i> Entregar Lente</h1>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <h2 class="text-center"><i class="fa fa-check mb-2"></i> Entregar Lente</h2>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-entregarLente"><i class="fa fa-hand-holding"></i> Entregar Lente</button>
            </div>
        </div>
    </div>
</div>
...
<script type="module">
    ...
    $(document).ready(function () {
        ...
        $('.btn-entregarLente').click(function(e) {
            e.preventDefault();
            ...
            axios.post(url,
                { params:
                    ...
                    bootstrap.Modal.getOrCreateInstance(document.getElementById('peLenteModal')).hide();
    ...
    const peLenteModal = document.getElementById('peLenteModal')

        peLenteModal.addEventListener('show.bs.modal', event => {
            ...
            peLenteModal.addEventListener('hidden.bs.modal', event => {
                /* personasTable.clear().draw(); */
                /* personasTable.destroy(); */
            });
    })

    function entregarLente(){
