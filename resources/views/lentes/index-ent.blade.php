...
@section('title', 'Administración de Lentes Entregados')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-person-circle-check"></i> Administración de Lentes Entregados</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-person-circle-check"></i> Administración de Lentes Entregados
            </div>
            <div class="float-end">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h1 class="modal-title fs-5" id="peLenteModalLabel"><i class="fa fa-check"></i> Lente Entregado</h1>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <h2 class="text-center"><i class="fa fa-check mb-2"></i> Lente Entregado</h2>
