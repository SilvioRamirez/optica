...
@section('title', 'Administración de Lentes en Laboratorios')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-check"></i> Administración de Lentes en Laboratorios</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-check"></i> Administración de Lentes en Laboratorios
            </div>
            <div class="float-end">
