...
@section('title', 'Eliminar Tipo de Pago')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-trash-alt"></i> Eliminar Tipo de Pago</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-trash-alt"></i> Eliminar Tipo de Pago
            </div>
            <div class="float-end">
        ...
        <div class="card-body">			
            ...
            {!! Form::open(['method' => 'DELETE','route' => ['tipos.destroy', $tipo->id],'style'=>'display:inline']) !!}
                ...
                <h2 class="text-center">¿Está segur@ de eliminar el Tipo de Pago: <strong>{{ $tipo->tipo }}</strong>?</h2>
                <hr>
