...
@section('title', 'Ver Tipo de Pago de Orden')

@section('content_header')
    <h1 class="text-center"><i class="fa fa-id-badge"></i> Ver Tipo de Pago de Orden</h1>
@stop
    ...
    <div class="card border-light mb-3 shadow">
        <div class="card-header bg-primary text-white">
            <div class="float-start">
                <i class="fa fa-id-badge"></i> Ver Tipo de Pago de Orden
            </div>
            <div class="float-end">
