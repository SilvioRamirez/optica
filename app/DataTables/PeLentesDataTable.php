...
class PeLentesDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                return '<div class="btn-group" role="group" aria-label="Opciones">
                            ...
                            <a class="btn btn-warning btn-sm"   title="Editar Lente"  onclick="openModal(\''.$query->id.'\')" href="'.route('pacientes.lente.edit', $query->id).'"><i class="fa fa-pencil"></i></a>
                            <button type="button" class="btn btn-success btn-sm" data-argid="'.$query->id.'" onclick="openModal(\''.$query->id.'\')"><i class="fa fa-check"></i></button>
                        </div>';
            })
    ...
    {
        return $model->newQuery()->where('status', 'POR ENTREGAR')->with('pacientes')->with('formulas')->with('tratamientos');
    }
