...
class EntLentesDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                return '<div class="btn-group" role="group" aria-label="Opciones">
                            <button type="button" class="btn btn-success btn-sm" data-argid="'.$query->id.'" onclick="openModal(\''.$query->id.'\')"><i class="fa fa-eye"></i></button>
                        </div>';
            })
    ...
    {
        return $model->newQuery()->where('status', 'ENTREGADO')->with('pacientes')->with('formulas')->with('tratamientos');
    }
