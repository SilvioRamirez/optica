...
class FormulariosDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('abono_1')->title('Abono 1'),
            Column::make('abono_fecha_1')->title('Abono Fecha 1'),
            Column::make('abono_2')->title('Abono 2'),
            Column::make('abono_fecha_2')->title('Abono Fecha 2'),
            Column::make('abono_3')->title('Abono 3'),
            Column::make('abono_fecha_3')->title('Abono Fecha 3'),
            Column::make('abono_4')->title('Abono 4'),
            Column::make('abono_fecha_4')->title('Abono Fecha 4'),
            Column::make('abono_5')->title('Abono 5'),
            Column::make('abono_fecha_5')->title('Abono Fecha 5'),
